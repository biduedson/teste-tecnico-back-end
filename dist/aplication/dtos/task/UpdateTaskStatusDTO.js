...
__decorate([
    (0, class_validator_1.IsString)({ message: "O id da tarefa deve ser uma string." }),
    (0, class_validator_1.IsNotEmpty)({ message: "O id da tarefa não pode estar vazio." }),
    __metadata("design:type", String)
], UpdateTaskStatusDTO.prototype, "id", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: "O status da tarefa não pode estar vazio." }),
